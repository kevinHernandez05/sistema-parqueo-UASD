      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            ...
            <li>
              <a href="registrar_salida_automovil.php"><strong>Registrar salida de automóvil</strong></a>
            </li>
          </ul>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <?php
              ...
              echo "<h2>Automoviles que siguen dentro del parqueo:</h2>";
              ...
              $consulta = 'SELECT cedula, nombre, apellido, tipoVehiculo, marca, modelo, color, anio, noPuertaEntrada, noPuertaSalida
              FROM registro
              WHERE noPuertaSalida > 0';
              ...
              echo "<h2>Automoviles que ya salieron del parqueo:</h2>";
              ...
              echo "<th>Modelo</th>";
              echo "<th>Puerta Entrada</th>";  
              echo "<th>Puerta Salida</th>";
              while ($columna = mysqli_fetch_array($resultado)){
                echo "<tr>";
                echo "<td>" . $columna['cedula'] . "</td><td>" . $columna['nombre'] . "</td><td>" . $columna['apellido'] . "</td><td>" . $columna['marca'] . "</td><td>" . $columna['modelo'] . "</td><td>" . $columna['noPuertaEntrada'] . "</td><td>" . $columna['noPuertaSalida'] . "</td>";
                echo "</tr>";
              }
              echo "</table>";  
